...
#define LIST_IMAGES_A_B \
	...
	IMG_DO(ASVGF_GRAD_SMPL_POS_A,     NUM_IMAGES_BASE + 28, R8_UINT,             r8ui,    IMG_WIDTH_GRAD_MGPU, IMG_HEIGHT_GRAD) \
	IMG_DO(ASVGF_GRAD_SMPL_POS_B,     NUM_IMAGES_BASE + 29, R8_UINT,             r8ui,    IMG_WIDTH_GRAD_MGPU, IMG_HEIGHT_GRAD) \
...
#define LIST_IMAGES_B_A \
	...
	IMG_DO(ASVGF_GRAD_SMPL_POS_B,     NUM_IMAGES_BASE + 28, R8_UINT,             r8ui,    IMG_WIDTH_GRAD_MGPU, IMG_HEIGHT_GRAD) \
	IMG_DO(ASVGF_GRAD_SMPL_POS_A,     NUM_IMAGES_BASE + 29, R8_UINT,             r8ui,    IMG_WIDTH_GRAD_MGPU, IMG_HEIGHT_GRAD) \
