...
static void create_buffers(void)
{
	...
	buffer_create(
		...
		VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_ACCELERATION_STRUCTURE_BUILD_INPUT_READ_ONLY_BIT_KHR | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT, 
		VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	buffer_attach_name(&transparency.beam_aabb_buffer, "transparency beam aabb buffer");
	...
	buffer_create(
		...
		VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	buffer_attach_name(&transparency.index_buffer, "transparency index buffer");
	...
	buffer_create(
		...
		VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	buffer_attach_name(&transparency.particle_color_buffer, "transparency particle color buffer");
	...
	buffer_create(
		...
		VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT,
		VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	buffer_attach_name(&transparency.beam_color_buffer, "transparency beam color buffer");
	...
	buffer_create(
		...
		VK_BUFFER_USAGE_UNIFORM_TEXEL_BUFFER_BIT | VK_BUFFER_USAGE_TRANSFER_DST_BIT,
		VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT);
	buffer_attach_name(&transparency.sprite_info_buffer, "transparency sprite info buffer");
